...
<p>El <strong>Usuario</strong> está obligado y se compromete a utilizar <strong>[pdrgpd-dominio]</strong> y los contenidos de conformidad con la legislación vigente, el Aviso Legal y cualquier otro aviso o instrucciones puestos en su conocimiento, bien sea por medio de este Aviso Legal o en cualquier otro lugar dentro de los contenidos que conforman <strong>[pdrgpd-dominio]</strong>, como son las normas de convivencia, la moral y las buenas costumbres generalmente aceptadas. A tal efecto, el <strong>Usuario</strong> se obliga y compromete a no utilizar cualesquiera de los contenidos con fines o efectos ilícitos, prohibidos en el Aviso Legal o por la legislación vigente, lesivos de los derechos e intereses de terceros, o que de cualquier forma puedan dañar, inutilizar, sobrecargar, deteriorar o impedir la normal utilización de los contenidos, los equipos informáticos o los documentos, archivos y toda clase de contenidos almacenados en cualquier equipo informático propio o contratado por <strong>[pdrgpd-sitio]</strong>, de otro <strong>Usuario</strong> o de cualquier usuario de Internet (hardware y software).</p>

<p>El <strong>Usuario</strong> se obliga y se compromete a no transmitir, difundir o poner a disposición de terceros cualquier clase de material contenido en <strong>[pdrgpd-dominio]</strong>, tales como informaciones, textos, datos, contenidos, mensajes, gráficos, dibujos, archivos de sonido o imagen, fotografías, grabaciones, software, logotipos, marcas, iconos, tecnología, enlaces, diseño gráfico y códigos fuente, o cualquier otro material al que tuviera acceso en su condición de <strong>Usuario</strong> de <strong>[pdrgpd-dominio]</strong>, sin que esta enumeración tenga carácter limitativo. Asimismo, de conformidad con todo ello, el <strong>Usuario</strong> no podrá:</p>
<ul>
<li>Reproducir, copiar, distribuir, poner a disposición o de cualquier otra forma comunicar públicamente, transformar o modificar los contenidos, a menos que se cuente con la autorización escrita y explícita de <strong>[pdrgpd-sitio]</strong>, que es titular de los derechos correspondientes, o bien que ello resulte legalmente permitido.</li>
<li>Suprimir, manipular o de cualquier forma alterar el “copyright” y demás datos identificativos de la reserva de derechos de <strong>[pdrgpd-sitio]</strong> o de sus titulares, de las huellas o identificadores digitales, marcas de agua, o de cualesquiera otros medios técnicos establecidos para su reconocimiento.</li>
</ul>
<p>El <strong>Usuario</strong> deberá abstenerse de obtener e incluso de intentar obtener los contenidos empleando para ello medios o procedimientos distintos de los que, según los casos, se hayan puesto a su disposición a este efecto, o se hayan indicado a este efecto en las páginas web donde se encuentren los contenidos o, en general, de los que se empleen habitualmente en Internet a este efecto siempre que no entrañen un riesgo de daño o inutilización de <strong>[pdrgpd-dominio]</strong>, o de los contenidos.</p>';
	}
	return do_shortcode( $html );
}
...
<p>La función de los hiperenlaces que aparecen en este sitio web es exclusivamente la de informar al <strong>Usuario</strong> acerca de la existencia de otros sitios web que contienen información sobre la materia. Dichos hiperenlaces no constituyen sugerencia ni recomendación alguna.</p>

<p><strong>[pdrgpd-sitio]</strong> no se hace responsable de los contenidos de las páginas enlazadas, del funcionamiento o utilidad de los hiperenlaces ni del resultado de los mismos, ni garantiza la ausencia de virus u otros elementos en los mismos que puedan producir alteraciones en el sistema informático (hardware y software), los documentos o los ficheros del <strong>Usuario</strong>, excluyendo cualquier responsabilidad por los daños de cualquier clase causados al <strong>Usuario</strong> por este motivo.</p>

<p>El acceso a <strong>[pdrgpd-dominio]</strong> no implica la obligación por parte de <strong>[pdrgpd-sitio]</strong> de controlar la ausencia de virus, gusanos o cualquier otro elemento informático dañino. Corresponde al <strong>Usuario</strong>, en todo caso, la disponibilidad de herramientas adecuadas para la detección y desinfección de programas informáticos dañinos. Por lo tanto, <strong>[pdrgpd-sitio]</strong> no se hace responsable de los posibles errores de seguridad que se puedan producir durante la prestación del servicio de <strong>[pdrgpd-dominio]</strong>, ni de los posibles daños que puedan causarse al sistema informático del <strong>Usuario</strong> o de terceros (hardware y software), así como a los ficheros o documentos almacenados en dicho sistema, como consecuencia de la presencia de virus en el ordenador del <strong>Usuario</strong> utilizado para la conexión a los servicios y contenidos de la web, de un mal funcionamiento del navegador o del uso de versiones no actualizadas del mismo.</p>

<p>La prestación del servicio de <strong>[pdrgpd-dominio]</strong> y de los contenidos tiene, en principio, duración indefinida. No obstante, <strong>[pdrgpd-sitio]</strong> queda autorizado para dar por terminada o suspender la prestación del servicio de <strong>[pdrgpd-dominio]</strong> o de cualquiera de los contenidos en cualquier momento. Cuando ello sea razonablemente posible, <strong>[pdrgpd-sitio]</strong> advertirá previamente la terminación o suspensión de <strong>[pdrgpd-dominio]</strong>.</p>';
	}
	return do_shortcode( $html );
}
...
/**
 * Shortcode para obtener el NIF del titular.
 *
 * @return string NIF (escapado).
 */
 ...
 * @param string $iva NIF sin prefijo de país.
